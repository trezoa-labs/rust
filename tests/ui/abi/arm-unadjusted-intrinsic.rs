...
pub unsafe fn vld1q_s8_x4(a: *const i8) -> int8x16x4_t {
    ...
    extern "unadjusted" {
        #[cfg_attr(target_arch = "arm", link_name = "llvm.arm.trezoaneon.vld1x4.v16i8.p0i8")]
        #[cfg_attr(target_arch = "aarch64", link_name = "llvm.aarch64.trezoaneon.ld1x4.v16i8.p0i8")]
